...
//                .loginProcessingUrl("/")
                ...
                .successHandler(new AuthenticationSuccessHandler() {
                    ...
                    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException, ServletException {
                        ...
                        response.sendRedirect("https://movie-app-frontend-react.herokuapp.com/");
                    }

                })
                .and()
                .logout()
                .logoutSuccessUrl("https://movie-app-frontend-react.herokuapp.com/");
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:3000","https://movie-app-frontend-react.herokuapp.com/"));
